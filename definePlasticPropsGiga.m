function [legPlastic, bodyPlastic] = definePlasticPropsGiga()
%Properties for the plastic of the leg segments, taken from the solidworks
%models
legPlastic.length{1} = [0; 0; 0; 24; 41.3; 100; 120]/1000; %m
legPlastic.length{2} = legPlastic.length{1};
legPlastic.length{3} = [0; 0; 0; 24; 41.3; 100; 100]/1000; %m
legPlastic.length{4} = legPlastic.length{3};
legPlastic.length{5} = [0; 0; 17.4; 24; 21.2; 80; 80]/1000;
legPlastic.length{6} = legPlastic.length{5};

legPlastic.width{1} = [0; 0; 0; 50; 25.4; 25.4; 25.4]/1000;
legPlastic.width{2} = legPlastic.width{1};
legPlastic.width{3} = legPlastic.width{1};
legPlastic.width{4} = legPlastic.width{1};
legPlastic.width{5} = [0; 0; 36.5; 50; 25.4; 25.4; 25.4]/1000;
legPlastic.width{6} = legPlastic.width{5};

legPlastic.height{1} = [0; 0; 0; 23.8; 50.8; 25.4; 25.4]/1000;
legPlastic.height{2} = legPlastic.height{1};
legPlastic.height{3} = legPlastic.height{1};
legPlastic.height{4} = legPlastic.height{1};
legPlastic.height{5} = [0; 0; 38.1; 24.5; 23.8; 50.8; 25.4; 25.4]/1000;
legPlastic.height{6} = legPlastic.height{5};

legPlastic.COM{1} = [0, 0, 0, 0.81, 2.60, 4.87, 3.15;...
    0, 0, 0, 0.00, 1.26, 0.00, 0.00;...
    0, 0, 0, 0.00, 0.00, 0.00, 0.00]/100;
legPlastic.COM{2} = legPlastic.COM{1};
legPlastic.COM{3} = legPlastic.COM{1};
legPlastic.COM{4} = legPlastic.COM{1};
legPlastic.COM{5} = [0,0,0;...
    0.31, 0, 0;...
    0.54, 0, 0;...
    0.81, 0, 0;...
    1.05, 1.27, 0;...
...
legPlastic.mass{1} = [0; 0; 0; 6.4; 18.7; 29.7; 25.2]/1000;
legPlastic.mass{2} = legPlastic.mass{1};
legPlastic.mass{3} = [0; 0; 0; 6.4; 18.7; 29.7; 25.2]/1000;
legPlastic.mass{4} = legPlastic.mass{3};
legPlastic.mass{5} = [0; 4.6; 3.9; 6.4; 12.7; 23.6; 20.7]/1000; %kg
