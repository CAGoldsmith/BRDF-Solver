...
legPlastic.mass{1} = [0; 6.4; 18.7; 29.7; 25.2]/1000;
legPlastic.mass{2} = legPlastic.mass{1};
legPlastic.mass{3} = [0; 6.4; 18.7; 29.7; 25.2]/1000;
legPlastic.mass{4} = legPlastic.mass{3};
legPlastic.mass{5} = [4.6; 3.9; 6.4; 12.7; 23.6; 20.7]/1000; %kg
